...
urlpatterns = [
    ...
    path("prospects/bulk-enrich/",views.prospect_bulk_enrich,name="prospect_bulk_enrich"),
    path("linkedin/",views.linkedin_board,name="linkedin_board"),
    path("web-intelligence/",views.web_intelligence_hub,name="web_intelligence_hub"),
    path("web-intelligence/add-to-prospects/",views.web_intelligence_add_to_prospects,name="web_intelligence_add_to_prospects"),
    path("web-intelligence/bulk-enrich/",views.web_intelligence_bulk_enrich,name="web_intelligence_bulk_enrich"),
    path("web-intelligence/add-to-campaign/",views.web_intelligence_add_to_campaign,name="web_intelligence_add_to_campaign"),
    path("contacts/<int:pk>/",views.contact_person_detail,name="contact_person_detail"),
